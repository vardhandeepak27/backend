...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        self.root.geometry("1550x800+0+0") #(+0+0) means starting from x=0,y=0
        # root.attributes('-fullscreen', True)  #To make it fullscreen

        #======1st Image======
        img1=Image.open("C:\Desktop\Images\hotel1.jpg")
        ...
        #======Right side image======
        img3=Image.open("C:\Desktop\Images\cabin.jpg")
        ...
        #======Down image======
        img4=Image.open("C:\Desktop\Images\hotel2.jpg")
        ...
        img5=Image.open("C:\Desktop\Images\khana.jpg")
